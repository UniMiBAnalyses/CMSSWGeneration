...
Use `MG5+Pythia8` to generate LO+PS ggZH events in which the Z-boson decays in pairs of leptons and the Higgs boson to gluons.
...
cd CMSSWGeneration/crab_miniaod_production/Era2017UL/ggZH_HToGluGlu_ZToLL_powheg_pythia8/
````
...
```sh
cmssw-el7
cd /afs/cern.ch/user/a/amassiro/Framework/Generation/CMSSW_10_6_30/src/
cmsenv;
cd CMSSWGeneration/crab_miniaod_production/Era2017UL/ggZH_HToGluGlu_ZToLL_powheg_pythia8/
````
...
powheg gridpack:
    ...
    /cvmfs/cms.cern.ch/phys_generator/gridpacks/UL/13TeV/powheg/V2/ggHZ_slc7_amd64_gcc700_CMSSW_10_6_27_ggZH_HToBB_ZToLL_M125_13TeV_powheg/
    /cvmfs/cms.cern.ch/phys_generator/gridpacks/UL/13TeV/powheg/V2/ggHZ_slc7_amd64_gcc700_CMSSW_10_6_27_ggZH_HToBB_ZToLL_M125_13TeV_powheg/v1/ggHZ_slc7_amd64_gcc700_CMSSW_10_6_27_ggZH_HToBB_ZToLL_M125_13TeV_powheg.tgz
...
There are example production configuration files, it is important in each of the to express
  ...
  * Number of events and events per-job that will be produced.
    ...
    crab submit -c crabConfig_ggZH_HToGluGlu_ZToLL_powheg_pythia8.py


    crab status -d ./crab_amassiro_crabConfig_ggZH_HToGluGlu_ZToLL
