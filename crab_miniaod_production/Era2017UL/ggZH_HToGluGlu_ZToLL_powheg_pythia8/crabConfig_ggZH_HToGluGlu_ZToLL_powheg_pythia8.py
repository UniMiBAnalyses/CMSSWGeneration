...
## General settings
config.General.requestName = 'amassiro_crabConfig_ggZH_HToGluGlu_ZToLL'
...
config.JobType.scriptArgs  = ['nEvents=1000','nThreads=4','outputName=nanoStep.root','inputGridpack=ggHZ_slc7_amd64_gcc700_CMSSW_10_6_27_ggZH_HToBB_ZToLL_M125_13TeV_powheg.tgz']
config.JobType.inputFiles  = ['script.sh','LHEGEN_step_cfg.py','SIM_step_cfg.py','DIGI_RAW_premix_step_cfg.py','HLT_step_cfg.py','RECO_step_cfg.py','MINIAOD_step_cfg.py','NANOAODv9_step_cfg.py','../pileup.py','ggHZ_slc7_amd64_gcc700_CMSSW_10_6_27_ggZH_HToBB_ZToLL_M125_13TeV_powheg.tgz']
...
config.Data.outputPrimaryDataset = 'ggZH_HToGluGlu_ZToLL'
